import { React, reactExports, jsxRuntimeExports, client } from "./chunk-DDi0q0f_.js";
import { sendMessageWithResponse, sendMessageFireAndForget, tBrowser, t, getCurrentLocale, setInterfaceLanguage, SUPPORTED_LANGUAGES, getLanguageName, SUPPORTED_LOCALES, localeToLanguageCode, callAPI, isChineseLanguage, getPosLabel, isCJKLanguage, CollectionBridge, initI18n } from "./chunk-Idcw88YU.js";
import { MessageSource, MessageType } from "./chunk-BqxQNjaF.js";
import "./chunk-BD1GsdAo.js";
const AuthBridge = {
  /**
   * Check current authentication status
   *
   * @returns Object containing authenticated status and optional user info
   */
  async checkAuth() {
    var _a, _b;
    try {
      const response = await sendMessageWithResponse(MessageSource.POPUP, MessageType.CHECK_AUTH);
      return {
        authenticated: ((_a = response == null ? void 0 : response.data) == null ? void 0 : _a.authenticated) || false,
        user: (_b = response == null ? void 0 : response.data) == null ? void 0 : _b.user
      };
    } catch (error) {
      console.error("[AuthBridge] checkAuth failed:", error);
   ...
   * @returns AuthResponse with user info on success
   */
   ...
   * @param language - Optional browser language for i18n verification email
   * @returns AuthResponse with registration result (message and email_sent status)
   */
  async register(email, password, name, language) {
    try {
      const response = await sendMessageWithResponse(MessageSource.POPUP, MessageType.AUTH_REGISTER, { email, password, name, language });
      return response;
    } catch (error) {
  ...
  /**
   * Login with Google OAuth (Fire-and-Forget)
   *
   * Triggers Google OAuth flow in Background Service.
   * The result will be broadcast via AUTH_GOOGLE_LOGIN_RESULT message.
   *
   * Popup should listen for AUTH_GOOGLE_LOGIN_RESULT to handle success/failure.
   *
   * Note: For logout, use the regular logout() method - it works for all users
   * including Google users (clears JWT tokens stored locally).
   */
  loginWithGoogle() {
    sendMessageFireAndForget(MessageSource.POPUP, MessageType.AUTH_GOOGLE_LOGIN, {});
  },
  /**
   ...
   * @param language - Browser language for i18n email content
   * @returns AuthResponse indicating success or failure
   */
...
;
function AuthPopup({ onLoginSuccess, onRegistrationSuccess }) {
  ...
  const handleGoogleLoginResult = reactExports.useCallback(
    (data) => {
      setIsLoading(false);
  ...
  reactExports.useEffect(() => {
    const messageListener = (message, _sender, _sendResponse) => {
      if (message.source === MessageSource.BACKGROUND && message.type === MessageType.AUTH_GOOGLE_LOGIN_RESULT) {
        handleGoogleLoginResult(message.data);
      }
    };
  ...
  const handleSubmit = async (e, type) => {
    ...
    try {
      if (type === "register") {
        ...
        const registerResult = await AuthBridge.register(
          email,
          password,
          username || void 0,
          browserLanguage
        ...
        const loginResult = await AuthBridge.login(email, password);
      ...
      const userResult = await AuthBridge.getUser();
  ...
  const handleGoogleLogin = () => {
    setError(null);
    setIsLoading(true);
    AuthBridge.loginWithGoogle();
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-popup-container", children: [
    isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-loading-overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-spinner" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-popup-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-tabs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: tBrowser("auth_login_tab")
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: tBrowser("auth_register_tab")
          }
        )
      ] }),
      activeTab === "login" && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: (e) => handleSubmit(e, "login"), className: "auth-form", children: [
        successMessage && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-success", children: successMessage }),
        error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-error", children: error }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "login-email", className: "auth-form-label", children: tBrowser("auth_email_label") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              id: "login-email",
              type: "email",
              placeholder: tBrowser("auth_email_placeholder"),
              value: email,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "login-password", className: "auth-form-label", children: tBrowser("auth_password_label") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              id: "login-password",
              type: "password",
              placeholder: tBrowser("auth_password_placeholder"),
              value: password,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-forgot-password", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", children: tBrowser("auth_forgotPassword") }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "auth-submit-button", disabled: isLoading, children: tBrowser("auth_login_button") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-divider", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-divider-line" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-divider-text", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: tBrowser("auth_or") }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              tBrowser("auth_googleLogin")
            ]
          }
        )
      ] }),
      activeTab === "register" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "form",
        {
          ...
          children: [
            error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-error", children: error }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-form-group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "register-username", className: "auth-form-label", children: tBrowser("auth_username_label") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  id: "register-username",
                  type: "text",
                  placeholder: tBrowser("auth_username_placeholder"),
                  value: username,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-form-group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "register-email", className: "auth-form-label", children: tBrowser("auth_email_label") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  id: "register-email",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-form-group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "register-password", className: "auth-form-label", children: tBrowser("auth_password_label") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  id: "register-password",
                  type: "password",
                  placeholder: `${tBrowser("auth_password_placeholder")} (${tBrowser("auth_passwordHint")})`,
                  value: password,
                  onChange: (e) => setPassword(e.target.value),
                  className: "auth-form-input",
                  minLength: 8,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-form-group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "register-confirm-password", className: "auth-form-label", children: tBrowser("auth_confirmPassword_label") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "auth-submit-button", disabled: isLoading, children: tBrowser("auth_register_button") })
          ]
        }
      )
    ] })
...
;
function PageHeader({ onBack, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-header-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "back-button", onClick: onBack, type: "button", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiChevronLeft, { size: 16 }) }),
    children
  ] }) });
}
...
function EmailVerificationPopup({
  ...
  const [error, setError] = reactExports.useState(null);
  const [resendSuccess, setResendSuccess] = reactExports.useState(false);
  const [countdown, setCountdown] = reactExports.useState(0);
  const calculateRemainingSeconds = reactExports.useCallback((endTime) => {
    const remaining = Math.ceil((endTime - Date.now()) / 1e3);
    return Math.max(0, remaining);
  }, []);
  const startCountdown = reactExports.useCallback(async () => {
    const endTime = Date.now() + RESEND_COOLDOWN_SECONDS * 1e3;
    await chrome.storage.local.set({ resendCooldownEndTime: endTime });
    setCountdown(RESEND_COOLDOWN_SECONDS);
  }, []);
  reactExports.useEffect(() => {
    const initCountdown = async () => {
      const { resendCooldownEndTime } = await chrome.storage.local.get("resendCooldownEndTime");
      if (resendCooldownEndTime) {
        const remaining = calculateRemainingSeconds(resendCooldownEndTime);
        if (remaining > 0) {
          setCountdown(remaining);
        } else {
          await chrome.storage.local.remove("resendCooldownEndTime");
        }
      }
    };
    initCountdown();
  ...
  reactExports.useEffect(() => {
    ...
    const timer = setInterval(() => {
      setCountdown((prev) => {
        if (prev <= 1) {
          chrome.storage.local.remove("resendCooldownEndTime");
          return 0;
        }
        return prev - 1;
      });
  ...
  const handleVerify = async (e) => {
    ...
    setIsLoading(true);
    try {
      const result = await AuthBridge.verifyEmail(verificationCode);
  ...
  const handleResend = async () => {
    ...
    try {
      const browserLanguage = chrome.i18n.getUILanguage();
      const result = await AuthBridge.resendVerification(email, browserLanguage);
      if (result.success) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "verification-container", children: [
    isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-loading-overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-spinner" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { onBack }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "verification-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "verification-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          width: "48",
          height: "48",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "verification-title", children: tBrowser("verification_title") || "Check your email" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "verification-description", children: tBrowser("verification_description") || `We've sent a verification code to ${email}. Please enter it below.` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "verification-email", children: email }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleVerify, className: "verification-form", children: [
        error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-error", children: error }),
        resendSuccess && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-success", children: tBrowser("verification_resent") || "Verification code resent successfully" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "verification-input-group", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
            value: verificationCode,
            onChange: (e) => setVerificationCode(e.target.value),
            placeholder: tBrowser("verification_code_placeholder") || "Enter verification code",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: isLoading ? tBrowser("verification_verifying") || "Verifying..." : tBrowser("verification_verify_button") || "Verify Email"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "verification-resend", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "verification-resend-text", children: tBrowser("verification_no_code") || "Didn't receive the code?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            children: isResending ? tBrowser("verification_resending") || "Resending..." : countdown > 0 ? tBrowser("verification_resend_countdown", formatCountdown(countdown)) || `Resend in ${formatCountdown(countdown)}` : tBrowser("verification_resend_button") || "Resend"
          }
        )
      ] })
    ] })
...
function HomePopup({
  ...
  const [user, setUser] = reactExports.useState(initialUser);
  const [error, setError] = reactExports.useState(null);
  const isDev = true;
  reactExports.useEffect(() => {
    const revalidateUser = async () => {
      try {
        const result = await AuthBridge.getUser();
        if (result.success && result.user) {
          setUser(result.user);
          setError(null);
        ...
        console.error("Failed to revalidate user:", error2);
        const errorMessage = error2 instanceof Error ? error2.message : "Failed to load user";
        setError(errorMessage);
      }
    };
    if (initialUser) {
  ...
  const handleLogout = async () => {
    try {
      ...
      const errorMessage = error2 instanceof Error ? error2.message : "Logout failed";
      setError(errorMessage);
    }
  };
  ...
  const handleOpenWebCollections = async () => {
    const { interfaceLanguage } = await chrome.storage.sync.get("interfaceLanguage");
    const locale = interfaceLanguage || "en";
    const baseUrl = isDev ? "http://localhost:3000" : "https://mokiedu.com";
    const url = `${baseUrl}/${locale}/collections`;
    chrome.tabs.create({ url });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "logged-in-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "logged-in-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-header-content user-profile", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "user-avatar", children: (user == null ? void 0 : user.picture_url) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx(FiUser, { size: 24 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "user-name", children: (user == null ? void 0 : user.name) || (user == null ? void 0 : user.email) || t("loggedIn_testUser") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          className: "anki-button",
          onClick: handleOpenWebCollections,
          title: t("loggedIn_openAnkiExport"),
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/anki.svg", alt: "Anki", width: 24, height: 24 })
        }
      )
    ] }) }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "logged-in-error", children: error }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "menu-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "menu-items", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "menu-item", onClick: handleMyCollection, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "menu-item-content", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FiBook, { size: 20, className: "menu-icon" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "menu-text", children: t("loggedIn_myCollection") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "menu-arrow", children: "→" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "menu-item", onClick: handleBrowsingHistory, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "menu-item-content", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FiClock, { size: 20, className: "menu-icon" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "menu-text", children: t("loggedIn_browsingHistory") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "menu-arrow", children: "→" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "menu-item", onClick: handleSettings, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "menu-item-content", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FiSettings, { size: 20, className: "menu-icon" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "menu-text", children: t("loggedIn_settings") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "menu-arrow", children: "→" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "menu-item", onClick: handleLogout, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "menu-item-content", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FiLogOut, { size: 20, className: "menu-icon" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "menu-text", children: t("loggedIn_logout") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "menu-arrow", children: "→" })
      ] }),
      isDev && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "menu-item", onClick: handleDebug, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "menu-item-content", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FiTool, { size: 20, className: "menu-icon" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "menu-text", children: "Debug" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "menu-arrow", children: "→" })
      ] })
    ] }) })
...
const SettingsBridge = {
  /**
   * Load current settings from Background Service
   *
   * @returns SettingsResponse with current settings
   */
  async loadSettings() {
    try {
      const response = await sendMessageWithResponse(
        MessageSource.POPUP,
        MessageType.SETTINGS_LOAD,
        {}
      );
      return response || { success: true, settings: DEFAULT_SETTINGS };
    } catch (error) {
      console.error("[SettingsBridge] loadSettings failed:", error);
      return { success: false, error: "Failed to load settings" };
    }
  },
  /**
   * Save settings through Background Service
   *
   * Background will:
   * 1. Save to chrome.storage.sync
   * 2. Broadcast SETTINGS_CHANGED to all YouTube tabs
   *
   * @param settings - Partial settings to save (only changed keys)
   * @returns SettingsResponse with updated settings
   */
  async saveSettings(settings) {
    try {
      const response = await sendMessageWithResponse(
        MessageSource.POPUP,
        MessageType.SETTINGS_SAVE,
        { settings }
      );
      return response || { success: false, error: "No response from Background" };
    } catch (error) {
      console.error("[SettingsBridge] saveSettings failed:", error);
      const errorMessage = error instanceof Error ? error.message : "Failed to save settings";
      return { success: false, error: errorMessage };
    }
  }
};
function SettingsPopup({ onBack }) {
  const [nativeLanguage, setNativeLanguage] = reactExports.useState("zh-CN");
  const [targetLanguage, setTargetLanguage] = reactExports.useState("en");
  const [interfaceLanguage, setInterfaceLanguageState] = reactExports.useState("zh_CN");
  const [isSaving, setIsSaving] = reactExports.useState(false);
  const [saveSuccess, setSaveSuccess] = reactExports.useState(false);
  reactExports.useEffect(() => {
    const loadSettings = async () => {
      const response = await SettingsBridge.loadSettings();
      if (response.success && response.settings) {
        setNativeLanguage(response.settings.nativeLanguage);
        setTargetLanguage(response.settings.targetLanguage);
        setInterfaceLanguageState(response.settings.interfaceLanguage);
      } else {
        setInterfaceLanguageState(getCurrentLocale());
      }
    };
    loadSettings();
  }, []);
  const handleSave = async () => {
    try {
      ...
      const interfaceChanged = interfaceLanguage !== currentLocale;
      const response = await SettingsBridge.saveSettings({
        nativeLanguage,
        targetLanguage,
        interfaceLanguage
      });
      ...
      if (interfaceChanged) {
        await setInterfaceLanguage(interfaceLanguage);
        window.location.reload();
        return;
      }
      setSaveSuccess(true);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { onBack, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-title-container", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FiSettings, { size: 20, className: "settings-icon" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "settings-title", children: t("settings_title") })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-form", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-form-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: t("settings_nativeLanguage") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "select-wrapper", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              ...
              children: SUPPORTED_LANGUAGES.map((code) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: code, children: getLanguageName(code) }, code))
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(FiChevronDown, { size: 16, className: "select-icon" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: t("settings_targetLanguage") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "select-wrapper", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: t("settings_interfaceLanguage") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "select-wrapper", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              ...
              onChange: (e) => setInterfaceLanguageState(e.target.value),
              children: SUPPORTED_LOCALES.map((locale) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: locale, children: getLanguageName(localeToLanguageCode(locale)) }, locale))
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(FiChevronDown, { size: 16, className: "select-icon" })
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          onClick: handleSave,
          disabled: isSaving,
          children: isSaving ? t("settings_saving") : saveSuccess ? t("settings_saved") : t("settings_save")
        }
      )
    ] }) })
  ] }) });
...
function formatRelativeTime(dateStr) {
  ...
  if (diffMins < 1) {
    return t("history_justNow");
  } else if (diffMins < 60) {
    return t("history_minutesAgo", diffMins.toString());
  } else if (diffHours < 24) {
    return t("history_hoursAgo", diffHours.toString());
  } else {
    return t("history_daysAgo", diffDays.toString());
  }
}
...
function BrowsingHistoryPopup({ onBack, onNavigateCollection }) {
  const [videoViews, setVideoViews] = reactExports.useState([]);
  ...
  reactExports.useEffect(() => {
    const loadVideoViews = async () => {
      try {
        setIsLoading(true);
        setError(null);
        const response = await callAPI("listVideoViews", {
          skip: 0,
          limit: PAGE_SIZE$1
        });
        setVideoViews(response.items);
  ...
  const loadMore = reactExports.useCallback(async () => {
    ...
    try {
      ...
      const response = await callAPI("listVideoViews", {
        skip: videoViews.length,
        limit: PAGE_SIZE$1
      });
      setVideoViews((prev) => [...prev, ...response.items]);
      setHasMore(videoViews.length + response.items.length < response.total);
    } catch (err) {
      console.error("Failed to load more video views:", err);
    } finally {
      setIsLoadingMore(false);
    }
  }, [isLoadingMore, hasMore, videoViews.length]);
  reactExports.useEffect(() => {
  ...
  const handleItemClick = (videoViewId, videoTitle) => {
    onNavigateCollection(videoViewId, videoTitle);
  };
  const handleJumpClick = (e, videoUrl) => {
    e.stopPropagation();
    chrome.tabs.create({ url: videoUrl });
  };
  const handleChannelClick = (e, channelUrl) => {
    e.stopPropagation();
    chrome.tabs.create({ url: channelUrl });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "history-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "history-content", ref: contentRef, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-header-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "back-button", onClick: onBack, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiChevronLeft, { size: 16 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "history-title-container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FiClock, { size: 20, className: "history-icon" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "history-title", children: t("loggedIn_browsingHistory") })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "history-list", children: [
      isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "history-loading", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading-spinner" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("loggedIn_loading") })
      ] }),
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "history-error", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: error }) }),
      !isLoading && !error && videoViews.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "history-empty", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FiClock, { size: 48, className: "empty-icon" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("history_empty") })
      ] }),
      !isLoading && !error && videoViews.map((videoView) => {
        const metadata = videoView.video.video_metadata;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "history-item",
            onClick: () => handleItemClick(videoView.id, videoView.video.video_title),
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "history-thumbnail", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: getYouTubeThumbnailUrl(videoView.video.video_id),
                  alt: videoView.video.video_title,
                  onError: (e) => {
                    ;
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "history-info", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "history-details", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "history-video-title", children: videoView.video.video_title }),
                  (metadata == null ? void 0 : metadata.channelName) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: `history-channel ${(metadata == null ? void 0 : metadata.channelUrl) ? "clickable" : ""}`,
                      onClick: (metadata == null ? void 0 : metadata.channelUrl) ? (e) => handleChannelClick(e, metadata.channelUrl) : void 0,
                      children: metadata.channelName
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "history-meta", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "history-platform", children: videoView.video.platform }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "history-time", children: formatRelativeTime(videoView.updated_at) })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    onClick: (e) => handleJumpClick(e, videoView.video.video_url),
                    "aria-label": "Open video",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiExternalLink, { size: 14 })
                  }
                )
              ] })
            ]
      ...
      isLoadingMore && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "history-loading-more", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading-spinner small" }) })
    ] })
  ] }) });
}
function extractPosSenses(entry) {
  if (!entry) return [];
  return [{ pos: entry.pos, senses: entry.senses }];
}
function CollectionItemExpanded({ collection, onClose }) {
  ...
  const pronunciationRef = reactExports.useRef(null);
  const entry = collection.entry;
  const getPronunciationUrl = () => {
    if (!(entry == null ? void 0 : entry.sounds) || entry.sounds.length === 0) return null;
    const sound = entry.sounds[0];
    return sound.mp3_url || sound.audio || sound.ogg_url || null;
  };
  const pronunciationUrl = getPronunciationUrl();
  const handlePronunciationClick = () => {
    if (!pronunciationUrl) return;
    try {
      ...
      console.error("Error creating pronunciation audio:", error);
    }
  };
  reactExports.useEffect(() => {
    if (entry && !selectedPos) {
      setSelectedPos(entry.pos);
    }
  }, [entry, selectedPos]);
  reactExports.useEffect(() => {
    if (collection.audio_url) {
      const audio = new Audio(collection.audio_url);
  ...
  const fallbackSenses = collection.definitions ? collection.definitions.split(/[;；]/).map((s) => s.trim()).filter(Boolean) : [];
  const formatPhonetic2 = (phonetic, romanization, langCode) => {
    if (isChineseLanguage(langCode)) {
      return romanization || "";
    }
    if (langCode === "ja" || langCode === "ko") {
      if (phonetic && romanization) {
        return `${phonetic}(${romanization})`;
      } else if (romanization) {
        return romanization;
      }
      return phonetic || "";
    }
    if (langCode === "en" && phonetic && !phonetic.startsWith("/")) {
      return `/${phonetic}/`;
    }
    return phonetic || "";
  };
  const formatPosLabel = (pos, targetLang, withBrackets = true) => {
    if (!pos) return "";
    const label = getPosLabel(pos.toLowerCase(), targetLang || "en");
    return withBrackets ? `[${label}]` : label;
  };
  const extractPhoneticFromEntry2 = () => {
    if (!entry || !entry.sounds || entry.sounds.length === 0) {
      return { phonetic: collection.phonetic, romanization: null };
    }
    const sound = entry.sounds[0];
    const langCode = collection.source_language;
    if (isCJKLanguage(langCode)) {
      return {
        phonetic: sound.phonetic || null,
        romanization: sound.romanization || null
      };
    }
    return {
      phonetic: sound.ipa || collection.phonetic,
      romanization: null
    };
  };
  const { phonetic: extractedPhonetic, romanization: extractedRomanization } = extractPhoneticFromEntry2();
  const formattedPhonetic = formatPhonetic2(
    extractedPhonetic,
    extractedRomanization,
    collection.source_language
  );
  const formattedPos = formatPosLabel(collection.pos, collection.source_language);
  const posSenses = extractPosSenses(entry);
  const currentPosSense = posSenses.find((ps) => ps.pos === selectedPos) || posSenses[0];
  const hasEntrySenses = entry && entry.senses.length > 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "collection-expanded-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { onBack: onClose }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "collection-expanded-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "expanded-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "expanded-word-row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "expanded-word", children: collection.word }),
          formattedPos && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "expanded-pos", children: formattedPos })
        ] }),
        (formattedPhonetic || pronunciationUrl) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "expanded-phonetic-row", children: [
          formattedPhonetic && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "expanded-phonetic", children: formattedPhonetic }),
          pronunciationUrl && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "expanded-sound-btn", onClick: handlePronunciationClick, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiVolume2, { size: 16 }) })
        ] })
      ] }),
      collection.definitions && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "expanded-short-def", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "expanded-def-emoji", children: "💬" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "expanded-def-text", children: collection.definitions })
      ] }),
      posSenses.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "expanded-pos-switcher", children: posSenses.map((ps) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          className: `expanded-pos-switcher-btn ${ps.pos === selectedPos ? "active" : ""}`,
          onClick: () => setSelectedPos(ps.pos),
          children: formatPosLabel(ps.pos, collection.source_language, false)
        },
        ps.pos
      )) }),
      hasEntrySenses && currentPosSense ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "expanded-senses", children: (() => {
        let glossIndex = 0;
        return currentPosSense.senses.flatMap(
          (sense) => sense.glosses.map((gloss) => {
            glossIndex++;
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "expanded-sense-row", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "expanded-sense-num", children: String(glossIndex).padStart(2, "0") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "expanded-sense-text", children: gloss.text })
            ] }, `${glossIndex}-${gloss.order}`);
          })
        );
      })() }) : (
        // Fallback: numbered senses list from definitions string
        fallbackSenses.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "expanded-senses", children: fallbackSenses.map((sense, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "expanded-sense-row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "expanded-sense-num", children: String(index + 1).padStart(2, "0") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "expanded-sense-text", children: sense })
        ] }, index)) })
      ),
      collection.image_url && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "expanded-thumbnail", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: collection.image_url, alt: collection.word }) }),
      collection.sentence && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "expanded-example", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "expanded-example-original", children: collection.sentence }),
        collection.translation && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "expanded-example-translation", children: collection.translation })
      ] }),
      collection.audio_url && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "expanded-audio-player", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "expanded-play-btn", onClick: handlePlayPause, children: isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(FiPause, { size: 16 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FiPlay, { size: 16 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "expanded-progress-container", onClick: handleProgressClick, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "expanded-progress-bar", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "expanded-duration", children: formatTime(duration) })
      ] })
    ] })
  ] });
}
const PAGE_SIZE = 20;
function MyCollectionPopup({ onBack, videoViewId, videoTitle }) {
  ...
  reactExports.useEffect(() => {
    const loadCollections = async () => {
      try {
        setIsLoading(true);
        setError(null);
        const response = await callAPI("getVideoCollections", {
          skip: 0,
          limit: PAGE_SIZE,
  ...
  const loadMore = reactExports.useCallback(async () => {
    ...
    try {
      ...
      setHasMore(collections.length + response.items.length < response.total);
    } catch (err) {
      console.error("Failed to load more collections:", err);
    } finally {
      setIsLoadingMore(false);
    }
  }, [isLoadingMore, hasMore, collections.length, videoViewId]);
  reactExports.useEffect(() => {
    const contentElement = contentRef.current;
    if (!contentElement) return;
    const handleScroll = () => {
  ...
  const handleJumpToVideo = (e, collection) => {
    e.stopPropagation();
    const timestampSeconds = Math.floor(collection.segment_begin / 1e3);
    const videoUrl = `${collection.video.video_url}&t=${timestampSeconds}`;
  ...
  const handleDelete = async (e, collectionId) => {
    ...
    try {
      await CollectionBridge.removeCollection(collectionId, videoViewId, MessageSource.POPUP);
  ...
  if (expandedCollection) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(CollectionItemExpanded, { collection: expandedCollection, onClose: handleCloseExpanded });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "collection-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "collection-content", ref: contentRef, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-header-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "back-button", onClick: onBack, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiChevronLeft, { size: 16 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "collection-title-container", children: [
        !videoViewId && /* @__PURE__ */ jsxRuntimeExports.jsx(FiBook, { size: 20, className: "collection-icon" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "collection-title", children: videoTitle || t("loggedIn_myCollection") })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "collection-list", children: [
      isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "collection-loading", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading-spinner" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("loggedIn_loading") })
      ] }),
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "collection-error", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: error }) }),
      !isLoading && !error && collections.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "collection-empty", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FiBook, { size: 48, className: "empty-icon" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("collection_empty") })
      ] }),
      !isLoading && !error && collections.map((collection) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "collection-item",
          onClick: () => handleItemClick(collection.id),
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "collection-thumbnail", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "collection-item-content", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "collection-text", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "collection-word", children: collection.word }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "collection-definition", children: collection.definitions })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "collection-actions", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    className: "collection-action-btn",
                    onClick: (e) => handleJumpToVideo(e, collection),
                    "aria-label": "Jump to video",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiExternalLink, { size: 16 })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    className: `collection-action-btn collection-delete-btn${deletingId === collection.id ? " deleting" : ""}`,
      ...
      isLoadingMore && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "collection-loading-more", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading-spinner small" }) })
    ] })
  ] }) });
}
const DEFAULT_ANKI_CONNECT_URL = "http://127.0.0.1:8765";
const API_VERSION = 6;
function getMokiFields() {
  return [
    { type: "none", label: "None", description: "Leave this field empty" },
    { type: "word", label: "Word", description: "The collected word" },
    { type: "pos", label: "POS", description: "Part of speech (noun, verb, etc.)" },
    { type: "sentence", label: "Sentence", description: "Original sentence containing the word" },
    { type: "translation", label: "Translation", description: "Translated sentence" },
    { type: "definition", label: "Definition", description: "Context-aware short definition" },
    {
      type: "fullDefinitions",
      label: "Full Definitions",
      description: "All definitions from dictionary"
    },
    { type: "phonetic", label: "Phonetic", description: "Pronunciation / IPA" },
    { type: "wordAudio", label: "Word Audio", description: "Word pronunciation from dictionary" },
    { type: "audio", label: "Context Audio", description: "Audio clip of the sentence" },
    { type: "image", label: "Image", description: "Video screenshot" }
  ];
}
async function ankiConnectRequest(action, params, ankiConnectUrl = DEFAULT_ANKI_CONNECT_URL) {
  const request = {
    action,
    version: API_VERSION,
    ...params && { params }
...
async function checkConnection(ankiConnectUrl = DEFAULT_ANKI_CONNECT_URL) {
  try {
    const version = await ankiConnectRequest("version", void 0, ankiConnectUrl);
    return version;
  } catch {
    return null;
  }
}
async function getDeckNames(ankiConnectUrl = DEFAULT_ANKI_CONNECT_URL) {
  return ankiConnectRequest("deckNames", void 0, ankiConnectUrl);
}
async function getModelNames(ankiConnectUrl = DEFAULT_ANKI_CONNECT_URL) {
  return ankiConnectRequest("modelNames", void 0, ankiConnectUrl);
}
async function getModelFieldNames(modelName, ankiConnectUrl = DEFAULT_ANKI_CONNECT_URL) {
  return ankiConnectRequest("modelFieldNames", { modelName }, ankiConnectUrl);
}
async function createDeck(deckName, ankiConnectUrl = DEFAULT_ANKI_CONNECT_URL) {
  return ankiConnectRequest("createDeck", { deck: deckName }, ankiConnectUrl);
}
async function addNote(note, ankiConnectUrl = DEFAULT_ANKI_CONNECT_URL) {
  return ankiConnectRequest("addNote", { note }, ankiConnectUrl);
}
async function addNotes(notes, ankiConnectUrl = DEFAULT_ANKI_CONNECT_URL) {
  return ankiConnectRequest("addNotes", { notes }, ankiConnectUrl);
}
async function storeMediaFile(filename, data, ankiConnectUrl = DEFAULT_ANKI_CONNECT_URL) {
  return ankiConnectRequest(
    "storeMediaFile",
    { filename, data, deleteExisting: true },
    ankiConnectUrl
  );
}
...
const EXPORT_SETTINGS_KEY = "ankiExportSettings";
async function saveExportSettings(settings) {
  await chrome.storage.local.set({ [EXPORT_SETTINGS_KEY]: settings });
}
async function loadExportSettings() {
  const result = await chrome.storage.local.get(EXPORT_SETTINGS_KEY);
  return result[EXPORT_SETTINGS_KEY] || DEFAULT_EXPORT_SETTINGS;
}
const MOKI_NOTE_TYPE = {
  name: "Moki Vocabulary",
  fields: [
    "Word",
    "POS",
    "Phonetic",
  ...
  // Card template: Word → Definition (based on CollectionItemExpanded layout)
  cardTemplates: [
    {
  ...
  // CSS styling based on CollectionItemExpanded design
  css: `.card {
...
async function hasMokiNoteType(ankiConnectUrl = DEFAULT_ANKI_CONNECT_URL) {
  const models = await getModelNames(ankiConnectUrl);
  return models.includes(MOKI_NOTE_TYPE.name);
}
async function createMokiNoteType(ankiConnectUrl = DEFAULT_ANKI_CONNECT_URL) {
  await ankiConnectRequest(
    "createModel",
    {
      modelName: MOKI_NOTE_TYPE.name,
      inOrderFields: MOKI_NOTE_TYPE.fields,
      css: MOKI_NOTE_TYPE.css,
      cardTemplates: MOKI_NOTE_TYPE.cardTemplates
    },
    ankiConnectUrl
  );
}
function extractPhoneticFromEntry(collection) {
  const entry = collection.entry;
  if (!entry || !entry.sounds || entry.sounds.length === 0) {
    return { phonetic: collection.phonetic, romanization: null };
  }
...
function formatPhonetic(phonetic, romanization, langCode) {
  if (isChineseLanguage(langCode)) {
    return romanization || "";
  }
  if (langCode === "ja" || langCode === "ko") {
...
function ExportPopup({ collectionIds, onBack, onExportComplete }) {
  const [ankiConnectUrl, setAnkiConnectUrl] = reactExports.useState("http://127.0.0.1:8765");
  const [connectionStatus, setConnectionStatus] = reactExports.useState("checking");
  const [availableDecks, setAvailableDecks] = reactExports.useState([]);
  const [availableModels, setAvailableModels] = reactExports.useState([]);
  const [modelFields, setModelFields] = reactExports.useState([]);
  const [deckName, setDeckName] = reactExports.useState("");
  const [modelName, setModelName] = reactExports.useState("");
  const [fieldMapping, setFieldMapping] = reactExports.useState({});
  const [tags, setTags] = reactExports.useState(["moki"]);
  ...
  const [isLoadingDecks, setIsLoadingDecks] = reactExports.useState(false);
  const [isLoadingModels, setIsLoadingModels] = reactExports.useState(false);
  const [isLoadingFields, setIsLoadingFields] = reactExports.useState(false);
  const [hasMokiTemplate, setHasMokiTemplate] = reactExports.useState(null);
  const [isCreatingTemplate, setIsCreatingTemplate] = reactExports.useState(false);
  const mokiFields = getMokiFields();
  reactExports.useEffect(() => {
    const loadSettings = async () => {
      const { ankiConnectUrl: savedUrl } = await chrome.storage.local.get("ankiConnectUrl");
      if (savedUrl) {
        setAnkiConnectUrl(savedUrl);
      }
      const savedSettings = await loadExportSettings();
      setDeckName(savedSettings.deckName);
      setModelName(savedSettings.modelName);
      setFieldMapping(savedSettings.fieldMapping);
      setTags(savedSettings.tags);
    };
    loadSettings();
  }, []);
  const checkAnkiConnection = reactExports.useCallback(async () => {
    setConnectionStatus("checking");
    const version = await checkConnection(ankiConnectUrl);
    if (version !== null) {
  ...
  const loadDecksAndModels = async () => {
    ...
    try {
      const [decks, models, hasMoki] = await Promise.all([
        getDeckNames(ankiConnectUrl),
        getModelNames(ankiConnectUrl),
        hasMokiNoteType(ankiConnectUrl)
      ]);
      setAvailableDecks(decks);
      setAvailableModels(models);
      setHasMokiTemplate(hasMoki);
    } catch (error) {
      console.error("Failed to load decks/models:", error);
    } finally {
      setIsLoadingDecks(false);
      setIsLoadingModels(false);
    }
  };
  const handleCreateMokiTemplate = async () => {
    setIsCreatingTemplate(true);
    setExportError(null);
    try {
      await createMokiNoteType(ankiConnectUrl);
      setHasMokiTemplate(true);
      const models = await getModelNames(ankiConnectUrl);
      setAvailableModels(models);
      setModelName(MOKI_NOTE_TYPE.name);
      setFieldMapping(MOKI_NOTE_TYPE.defaultMapping);
    } catch (error) {
      setExportError(error instanceof Error ? error.message : t("export_createTemplateFailed"));
    } finally {
      setIsCreatingTemplate(false);
    }
  };
  reactExports.useEffect(() => {
    if (!modelName || connectionStatus !== "connected") {
      setModelFields([]);
      return;
    }
    const loadFields = async () => {
      ...
      try {
        const fields = await getModelFieldNames(modelName, ankiConnectUrl);
        setModelFields(fields);
        if (modelName === MOKI_NOTE_TYPE.name) {
          setFieldMapping(MOKI_NOTE_TYPE.defaultMapping);
        } else {
          setFieldMapping((prev) => {
            const newMapping = {};
            for (const field of fields) {
              newMapping[field] = prev[field] || "none";
            }
            return newMapping;
          });
        }
    ...
    loadFields();
  }, [modelName, connectionStatus, ankiConnectUrl]);
  reactExports.useEffect(() => {
    const settings = {
      deckName,
      modelName,
  ...
  }, [deckName, modelName, fieldMapping, tags]);
  const handleUrlChange = async (newUrl) => {
    setAnkiConnectUrl(newUrl);
    await chrome.storage.local.set({ ankiConnectUrl: newUrl });
  };
  const handleFieldMappingChange = (ankiField, mokiField) => {
    setFieldMapping((prev) => ({
      ...prev,
      [ankiField]: mokiField
    }));
  ...
  const collectionToAnkiNote = async (collection, mapping, deckName2, modelName2, tags2) => {
    var _a, _b, _c, _d, _e;
    const fields = {};
    const audio = [];
    const picture = [];
    const { phonetic: extractedPhonetic, romanization } = extractPhoneticFromEntry(collection);
    const formattedPhonetic = formatPhonetic(
      extractedPhonetic,
      romanization,
      collection.source_language
    );
    for (const [ankiField, mokiField] of Object.entries(mapping)) {
      switch (mokiField) {
        case "word":
          fields[ankiField] = collection.word || "";
          break;
        case "pos":
          if (collection.pos) {
            const posLabel = getPosLabel(
              collection.pos.toLowerCase(),
              collection.source_language || "en"
            );
            fields[ankiField] = `[${posLabel}]`;
          } else {
            fields[ankiField] = "";
          }
          break;
        case "sentence":
          fields[ankiField] = collection.sentence || "";
          break;
        case "translation":
          fields[ankiField] = collection.translation || "";
          break;
        case "definition":
          fields[ankiField] = collection.definitions || "";
          break;
        case "fullDefinitions":
          if ((_a = collection.entry) == null ? void 0 : _a.senses) {
            let glossIndex = 0;
            const allDefs = collection.entry.senses.flatMap(
              (sense) => sense.glosses.map((gloss) => {
                glossIndex++;
                return `${String(glossIndex).padStart(2, "0")} ${gloss.text}`;
              })
            ).join("\n");
            fields[ankiField] = allDefs;
          } else {
            fields[ankiField] = "";
          }
          break;
        case "phonetic":
          fields[ankiField] = formattedPhonetic;
          break;
        case "wordAudio":
          fields[ankiField] = "";
          break;
    ...
    if (collection.audio_url) {
      const audioField = (_b = Object.entries(mapping).find(([, v]) => v === "audio")) == null ? void 0 : _b[0];
      if (audioField) {
        const audioBase64 = await fetchUrlAsBase64(collection.audio_url);
        if (audioBase64) {
          audio.push({
            data: audioBase64,
            filename: `moki_${collection.id}_audio.mp3`,
            fields: [audioField]
          });
        }
      }
    }
    const wordAudioField = (_c = Object.entries(mapping).find(([, v]) => v === "wordAudio")) == null ? void 0 : _c[0];
    if (wordAudioField) {
      const entry = collection.entry;
      const sound = (_d = entry == null ? void 0 : entry.sounds) == null ? void 0 : _d[0];
      const pronunciationUrl = (sound == null ? void 0 : sound.mp3_url) || (sound == null ? void 0 : sound.audio) || (sound == null ? void 0 : sound.ogg_url) || null;
      if (pronunciationUrl) {
        const wordAudioBase64 = await fetchUrlAsBase64(pronunciationUrl);
        if (wordAudioBase64) {
          audio.push({
            data: wordAudioBase64,
            filename: `moki_${collection.id}_word_audio.mp3`,
    ...
    if (collection.image_url) {
      const imageField = (_e = Object.entries(mapping).find(([, v]) => v === "image")) == null ? void 0 : _e[0];
      if (imageField) {
        const imageBase64 = await fetchUrlAsBase64(collection.image_url);
        if (imageBase64) {
          picture.push({
            data: imageBase64,
            filename: `moki_${collection.id}_image.jpg`,
            fields: [imageField]
          });
        }
      }
  ...
  const handleExport = async () => {
    if (connectionStatus !== "connected") {
      setExportError(t("export_ankiNotConnected"));
      return;
    }
    if (!deckName) {
      setExportError(t("export_noDeckSelected"));
      return;
    }
    if (!modelName) {
      setExportError(t("export_noModelSelected"));
      return;
    }
    setIsExporting(true);
    setExportError(null);
    setExportProgress({ current: 0, total: collectionIds.length, status: "fetching" });
    try {
      const collections = [];
      for (let i = 0; i < collectionIds.length; i++) {
        setExportProgress({ current: i + 1, total: collectionIds.length, status: "fetching" });
      ...
      setExportProgress({ current: 0, total: collections.length, status: "exporting" });
      const notes = [];
      for (let i = 0; i < collections.length; i++) {
        setExportProgress({ current: i + 1, total: collections.length, status: "exporting" });
        const note = await collectionToAnkiNote(
          collections[i],
          fieldMapping,
          deckName,
          modelName,
      ...
      const results = await addNotes(notes, ankiConnectUrl);
      const failedCount = results.filter((r) => r === null).length;
      if (failedCount > 0 && failedCount === results.length) {
        throw new Error(t("export_allFailed") || "All notes failed to export");
      }
  ...
  const isExportDisabled = isExporting || connectionStatus !== "connected" || !deckName || !modelName;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "export-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "export-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { onBack: handleCancel, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "export-title-container", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FiDownload, { size: 20, className: "export-icon" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "export-title", children: t("export_title") })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "export-form", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "export-form-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "export-info-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "export-info-label", children: t("export_wordCount") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "export-info-value", children: collectionIds.length })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: t("export_ankiConnectUrl") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "url-input-wrapper", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FiServer, { size: 16, className: "url-icon" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              title: t("export_refreshConnection"),
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                FiRefreshCw,
                {
                  size: 14,
                  className: connectionStatus === "checking" ? "spinning" : ""
                }
              )
            }
          )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "connection-status", children: [
        connectionStatus === "checking" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "status-item status-checking", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "status-spinner" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("export_checkingConnection") })
        ] }),
        connectionStatus === "connected" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "status-item status-connected", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FiCheckCircle, { size: 16 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("export_ankiConnected") })
        ] }),
        connectionStatus === "disconnected" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "status-item status-disconnected", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FiAlertCircle, { size: 16 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("export_ankiDisconnected") })
        ] })
      ] }),
      connectionStatus === "connected" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: t("export_deck") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              className: "form-select",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: t("export_selectDeck") }),
                availableDecks.map((deck) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: deck, children: deck }, deck))
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: t("export_noteType") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              className: "form-select",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: t("export_selectNoteType") }),
                availableModels.map((model) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: model, children: model }, model))
              ]
            }
          ),
          hasMokiTemplate === false && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              className: "create-template-button",
              onClick: handleCreateMokiTemplate,
              disabled: isCreatingTemplate,
              children: isCreatingTemplate ? t("export_creatingTemplate") : t("export_createRecommendedTemplate")
            }
          )
        ] }),
        modelFields.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: t("export_fieldMapping") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "field-mapping-list", children: isLoadingFields ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading-text", children: t("export_loadingFields") }) : modelFields.map((field) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "field-mapping-row", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "anki-field-name", children: field }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "field-arrow", children: "→" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "select",
              {
                ...
                children: mokiFields.map((mokiField) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: mokiField.type, children: mokiField.label }, mokiField.type))
              }
            )
          ] }, field)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: t("export_tags") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
              ...
              placeholder: "moki, youtube"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "form-hint", children: t("export_tagsHint") })
        ] })
      ] }),
      exportError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "export-error", children: exportError }),
      exportProgress && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "export-progress", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "export-progress-bar", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "export-progress-text", children: exportProgress.status === "fetching" ? t("export_fetchingData") || `Fetching data... ${exportProgress.current}/${exportProgress.total}` : t("export_exportingToAnki") || `Exporting to Anki... ${exportProgress.current}/${exportProgress.total}` })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: isExporting ? t("export_exporting") : t("export_startExport")
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "export-help", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: t("export_helpText") }) })
    ] }) })
  ] }) });
}
function App() {
  const [isAuthenticated, setIsAuthenticated] = reactExports.useState(null);
  const [isI18nReady, setIsI18nReady] = reactExports.useState(false);
  const [initialUser, setInitialUser] = reactExports.useState(null);
  const [currentView, setCurrentView] = reactExports.useState("main");
  const [videoCollectionState, setVideoCollectionState] = reactExports.useState(
    null
  );
  const [authView, setAuthView] = reactExports.useState("login");
  const [verificationEmail, setVerificationEmail] = reactExports.useState("");
  ...
  reactExports.useEffect(() => {
    const init = async () => {
      ...
      const { pendingExport: storedPendingExport } = await chrome.storage.local.get("pendingExport");
      if (storedPendingExport) {
        const isRecent = Date.now() - storedPendingExport.timestamp < 5 * 60 * 1e3;
        if (isRecent && ((_a = storedPendingExport.collectionIds) == null ? void 0 : _a.length) > 0) {
          setPendingExport(storedPendingExport);
        } else {
          await chrome.storage.local.remove("pendingExport");
        }
      }
      const { authenticated, user } = await AuthBridge.checkAuth();
      if (authenticated) {
        await chrome.storage.local.remove("pendingVerificationEmail");
      }
      setInitialUser(user || null);
      setIsAuthenticated(authenticated);
      if (authenticated && storedPendingExport) {
        const isRecent = Date.now() - storedPendingExport.timestamp < 5 * 60 * 1e3;
        if (isRecent && ((_b = storedPendingExport.collectionIds) == null ? void 0 : _b.length) > 0) {
  ...
  if (isAuthenticated === null || !isI18nReady) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: isI18nReady ? t("loggedIn_loading") : "Loading..."
      }
    );
  }
  const handleLoginSuccess = async (user) => {
    await chrome.storage.local.remove(["pendingVerificationEmail", "resendCooldownEndTime"]);
    setVerificationEmail("");
    setAuthView("login");
    setInitialUser(user);
    setIsAuthenticated(true);
    if (pendingExport && pendingExport.collectionIds.length > 0) {
      setCurrentView("export");
    }
  };
  const handleLogout = () => {
  ...
  const handleRegistrationSuccess = async (email) => {
    const resendCooldownEndTime = Date.now() + 120 * 1e3;
    await chrome.storage.local.set({ pendingVerificationEmail: email, resendCooldownEndTime });
    setVerificationEmail(email);
    setAuthView("verification");
  };
  const handleVerificationBack = async () => {
    await chrome.storage.local.remove(["pendingVerificationEmail", "resendCooldownEndTime"]);
    setAuthView("login");
    setVerificationEmail("");
  };
  if (!isAuthenticated) {
    if (authView === "verification" && verificationEmail) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
  ...
  if (currentView === "settings") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsPopup, { onBack: () => setCurrentView("main") });
  }
  if (currentView === "history") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      BrowsingHistoryPopup,
      {
        onBack: () => setCurrentView("main"),
        onNavigateCollection: (videoViewId, videoTitle) => {
          setVideoCollectionState({ videoViewId, videoTitle });
  ...
  if (currentView === "collection") {
    const goBackToHistory = videoCollectionState !== null;
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      MyCollectionPopup,
      {
        onBack: () => {
          setVideoCollectionState(null);
          setCurrentView(goBackToHistory ? "history" : "main");
        },
        videoViewId: videoCollectionState == null ? void 0 : videoCollectionState.videoViewId,
        videoTitle: videoCollectionState == null ? void 0 : videoCollectionState.videoTitle
      }
    );
  }
  if (currentView === "export" && pendingExport) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ExportPopup,
      {
        collectionIds: pendingExport.collectionIds,
        onBack: () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    HomePopup,
    {
      ...
      onNavigateCollection: () => setCurrentView("collection"),
      onLogout: handleLogout
    }
  );
}
client.createRoot(document.getElementById("app")).render(/* @__PURE__ */ jsxRuntimeExports.jsx(App, {}));
//# sourceMappingURL=chunk-BL8hZBas.js.map
