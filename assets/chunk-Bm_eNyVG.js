...
import { sendMessageWithResponse, tBrowser, t, getCurrentLocale, setInterfaceLanguage, SUPPORTED_LANGUAGES, getLanguageName, SUPPORTED_LOCALES, localeToLanguageCode, callAPI, CollectionBridge, initI18n } from "./chunk--DVCTphW.js";
...
;
function AuthPopup({ onLoginSuccess }) {
  ...
  const handleSubmit = async (e, type) => {
    ...
    try {
      if (type === "register") {
        const registerResult = await AuthBridge.register(email, password, username || void 0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-popup-container", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-popup-content", children: [
      ...
      activeTab === "login" && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: (e) => handleSubmit(e, "login"), className: "auth-form", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: "auth-google-button", children: [
...
function HomePopup({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "logged-in-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "logged-in-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-header-content user-profile", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "user-avatar", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiUser, { size: 24 }) }),
...
function SettingsPopup({ onBack }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-header-content", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-title-container", children: [
...
function MyCollectionPopup({ onBack, videoViewId, videoTitle }) {
  ...
  const [hasMore, setHasMore] = reactExports.useState(true);
  const [error, setError] = reactExports.useState(null);
  const [sourceLanguage, setSourceLanguage] = reactExports.useState(null);
  ...
  reactExports.useEffect(() => {
    if (videoViewId) {
      chrome.storage.sync.get("targetLanguage").then((result) => {
        setSourceLanguage(result.targetLanguage || "en");
      });
    }
  }, [videoViewId]);
  reactExports.useEffect(() => {
    if (videoViewId && !sourceLanguage) return;
    const loadCollections = async () => {
      try {
        ...
        const response = await callAPI("getVideoCollections", {
          ...
          source_language: videoViewId ? sourceLanguage : void 0
        });
  ...
  }, [isLoadingMore, hasMore, collections.length, videoViewId, sourceLanguage]);
  reactExports.useEffect(() => {
    const contentElement = contentRef.current;
    if (!contentElement) return;
    const handleScroll = () => {
  ...
  const handlePlayAudio = (e, collection) => {
    e.stopPropagation();
    ...
    const audio = new Audio(collection.audio_base64);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "collection-list", children: [
      ...
      !isLoading && !error && collections.map((collection) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          onClick: () => handleItemClick(collection.video.video_url),
          children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "collection-actions", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    onClick: (e) => handlePlayAudio(e, collection),
                    "aria-label": playingId === collection.id ? "Stop" : "Play",
                    children: playingId === collection.id ? /* @__PURE__ */ jsxRuntimeExports.jsx(FiSquare, { size: 16 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FiPlay, { size: 16 })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
...
function App() {
  ...
  if (!isAuthenticated) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthPopup, { onLoginSuccess: handleLoginSuccess });
  }
...
//# sourceMappingURL=chunk-Bm_eNyVG.js.map
